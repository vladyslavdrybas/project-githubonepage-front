...
import { salute, rustyRed, rainforestNights, darkSideOfTheMoon } from '@/styles/colors';
...
export const brand = rustyRed;

export const secondary = salute;

export const gray = darkSideOfTheMoon;

export const green = rainforestNights;
